...
/*         <div className={addStyles}>
          ...
          <div >
            ...
            <div class={contentCardStyles}>
                ...
                <div className="flex flex-wrap  h-100 justify-start  items-center mt-1 gap-x-2 truncate ...">

                    {he.decode(cardData.in_cub) !== "0.00" && he.decode(cardData.in_cub) !== "" && <span className="flex items-center text-base font-thin text-gray-700 mr-2 mb-2 gap-1 "><RuleIcon h="16" w="16" /> {he.decode(cardData?.in_cub)}m²</span>}
                    {he.decode(cardData.in_sto) !== "0.00" && he.decode(cardData.in_sto) !== "" && <span className="flex items-center text-base font-thin text-gray-700 mr-2 mb-2 gap-1 "><SquareMeterIcon  h="16" w="16"/> {he.decode(cardData?.in_sto)}m²</span>}
