    ...
    <>
      <ul className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mb-10 gap-y-3">
        ...
        {operation !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Operación: </span>
          <p className="text-sm md:text-md lg:text-lg">{he.decode(operation)}</p>
        </li>) : null}
        {locationLoc !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Localidad: </span>
          <span className="text-sm md:text-md lg:text-lg">{he.decode(locationLoc)}</span>
        </li>) : null}
        {locationLoc !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Barrio: </span>
          <span className="text-sm md:text-md lg:text-lg">{he.decode(neighborhood)}</span>
        </li>) : null}
        {address !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Dirección: </span>
        ...
        {environments !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Ambientes: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(environments))}</span>
        </li>) : null}
        {(antiquity !== "" && antiquity !== "0") ? (
          <li className="flex gap-2">
            <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Antigüedad: </span>
        ...
        {(expenses !== "") ? (
          <li className="flex gap-2">
            <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Expensas: </span>
        ...
        {(locationUbi !== "") ? (
          <li className="flex gap-2">
            <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Ubicación: </span>
            <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(locationUbi))}</span>
          </li>
        ) : null}
        {houseType !== "" ? (
          <li className="flex gap-2">
            <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Tipo de casa: </span>
            <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(houseType))}</span>
          </li>) : null}

        {dependence !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Dependencia: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(dependence)) === "S" ? "Si" : "No"}</span>
        </li>) : null}
        {floors !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Pisos: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(floors))}</span>
        </li>) : null}
        {hotWater !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Agua caliente: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(hotWater))}</span>
        </li>) : null}
        {gas !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Gas: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(gas))}</span>
        </li>) : null}
        {heating !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Calefacción: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(heating))}</span>
        </li>) : null}
        {bathrooms !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Baños: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(bathrooms))}</span>
        </li>) : null}
        {state !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Estado: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(state))}</span>
        </li>) : null}
        {garage_parking !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Cochera: </span>
        ...
        {(garage !== "" && garage !== "0") ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Garage: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(garage))}</span>
        </li>) : null}
        {parking !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Estacionamiento: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(parking))}</span>
        </li>) : null}
        {pavement !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Pavimento: </span>
          <span className="text-sm md:text-md lg:text-lg">{capitalize(he.decode(pavement)) === "S" ? "Si" : "No"}</span>
        </li>) : null}
        {sewer !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Cloacas: </span>
        ...
        {telephoneLine !== "" ? (<li className="flex gap-2">
          <span className="text-sm md:text-md lg:text-lg font-gothamBold font-bold text-secondary-text-msb">Línea telefónica: </span>
