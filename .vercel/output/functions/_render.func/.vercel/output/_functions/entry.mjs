...
const pageMap = new Map([
    ...
    ["src/pages/api/addUser.json.ts", _page2],
    ["src/pages/api/consultationProperty.json.ts", _page3],
    ["src/pages/api/destacados.json.ts", _page4],
    ...
    ["src/pages/api/[id].json.ts", _page13],
    ["src/pages/contacto/index.astro", _page14],
    ["src/pages/emprendimientos/[...emprendimiento]/unidad-disponible/[...operacion]/[propiedad].astro", _page15],
    ["src/pages/emprendimientos/[...emprendimiento]/[propiedad].astro", _page16],
    ["src/pages/emprendimientos/index.astro", _page17],
    ["src/pages/favoritos/index.astro", _page18],
    ["src/pages/invierta-en-usa/index.astro", _page19],
    ["src/pages/resultados-de-busqueda/[...operacion]/[propiedad].astro", _page20],
    ["src/pages/resultados-de-busqueda/index.astro", _page21],
    ["src/pages/servicios/administracion/index.astro", _page22],
    ["src/pages/servicios/tasaciones/index.astro", _page23],
    ["src/pages/servicios/index.astro", _page24],
    ["src/pages/sumate/index.astro", _page25],
    ["src/pages/tasaciones/index.astro", _page26],
    ["src/pages/usuarios/index.astro", _page27],
